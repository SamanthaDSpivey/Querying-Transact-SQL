--Lab 08- Use grouping sets and the PIVOT operator to summarize data in the AdventureWorksLT database


--Retrieve Regional Sales Totals- Initial query
...
--Retrieve Customer sales by parent category
SELECT * FROM
